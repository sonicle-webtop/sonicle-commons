...
public class DelayedEntry implements Delayed {
	...
	public DelayedEntry(long delayInMilliseconds) {
		this.startMillis = System.currentTimeMillis() + delayInMilliseconds;
	}
	...
	public int compareTo(Delayed o) {
		if (this.startMillis < ((DelayedEntry)o).startMillis) {
			return -1;
		} else if (this.startMillis > ((DelayedEntry)o).startMillis) {
			return 1;
		} else {
			return 0;
		}
