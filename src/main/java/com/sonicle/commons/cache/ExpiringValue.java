...
public class ExpiringValue<V> {
	...
	public ExpiringValue(V value, long lastAccessTime) {
		if (value == null) throw new IllegalArgumentException("An expiring object cannot be null.");
		this.value = value;
	...
	public boolean equals(Object obj) {
		...
		if (value.getClass() != obj.getClass()) return false;
